...
# translation
SOURCES = antennaintervisibility.py ui_antennaintervisibility.py __init__.py antennaintervisibilitydialog.py
#TRANSLATIONS = i18n/antennaintervisibility_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = antennaintervisibility

PY_FILES = antennaintervisibility.py antennaintervisibilitydialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_antennaintervisibility.py
